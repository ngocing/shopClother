...
namespace DAL
{
    public class DAL_XemLoiNhuan
    {
        static SqlConnection connect;
        public DataTable Get()
        {
            string lenh = @"SELECT Hoa_Don.ngay_lap, San_Pham.ten_sp,Ct_Hoa_Don.so_luong,Ct_Hoa_Don.don_gia ,San_Pham.don_gia as don_gia_goc, Hoa_Don.ma_hd, Ct_Hoa_Don.so_luong*San_Pham.don_gia*San_Pham.loi_nhuan as loi_nhuan
FROM            ((Ct_Hoa_Don INNER JOIN Hoa_Don ON Ct_Hoa_Don.ma_hd = Hoa_Don.ma_hd) INNER JOIN San_Pham ON Ct_Hoa_Don.ma_sp = San_Pham.ma_sp)";
        ...
        {
            string lenh = string.Format(@"SELECT Hoa_Don.ngay_lap, San_Pham.ten_sp,Ct_Hoa_Don.so_luong,Ct_Hoa_Don.don_gia ,San_Pham.don_gia as don_gia_goc, Hoa_Don.ma_hd, Ct_Hoa_Don.so_luong*San_Pham.don_gia*San_Pham.loi_nhuan as loi_nhuan
